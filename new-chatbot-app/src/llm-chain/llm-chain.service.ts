...
export class LlmChainService {
  ...
  public async getModelResponse(
    ...
    this.totalLlmTokenUsage = this.tokenUsageService.combineTokenUsage(this.totalLlmTokenUsage, tokenUsage);

    return response;
  }

  public getTokenUsage(): TokenUsage {
    return this.tokenUsageService.combineTokenUsage(this.totalLlmTokenUsage, this.memoryService.getTokenUsage());
  }
}
