...
/**
 * Authorization Service of LibAnswer
 */
@Injectable()
export class LibAnsAuthorizationService implements OnModuleInit {
  private readonly OAUTH_URL: string =
    this.retrieveEnvironmentVariablesService.retrieve('LIB_ANS_OAUTH_URL');
  private readonly CLIENT_ID: string =
    this.retrieveEnvironmentVariablesService.retrieve('LIB_ANS_CLIENT_ID');
  private readonly CLIENT_SECRET: string =
    this.retrieveEnvironmentVariablesService.retrieve('LIB_ANS_CLIENT_SECRET');
  private readonly GRANT_TYPE: string =
    this.retrieveEnvironmentVariablesService.retrieve('LIB_ANS_GRANT_TYPE');
  ...
  /**
   * Get the Observable for access token for LibAns API
  ...
  /**
   * Reset the access token for LibAns
   */
