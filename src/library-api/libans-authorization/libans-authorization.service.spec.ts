...
import { LibAnsAuthorizationService } from './libans-authorization.service';
...
describe('LibAnsAuthorizationService', () => {
  let service: LibAnsAuthorizationService;
  let httpService: HttpService;

  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      imports: [HttpModule, LibraryApiModule, SharedModule],
      providers: [LibAnsAuthorizationService],
    }).compile();

    service = module.get<LibAnsAuthorizationService>(
