...
class PromptWithTools implements PromptTemplate {
  ...
  private constructReActModelDescription(
    ...
    const reActModelDescription: string = `Your job is to complete the scratchpad to guide yourself toward the answer. For the scratchpad, format your answer as in this JSON structure:\n\
    {
