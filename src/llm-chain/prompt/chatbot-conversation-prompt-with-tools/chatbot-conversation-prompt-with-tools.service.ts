...
export class ChatbotConversationPromptWithToolsService implements Prompt {
  ...
  constructor(
    ...
    this.modelDescription =
      ...
      })}\nIn your final answer, provide the helpful response. If you used sources (for example from RagFaqSearch), append a section titled "References:" followed by one URL per line for the sources you used. If no sources were used, omit the References section.`;
